  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Mönchengladbach | Friseursalon Mousa</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Mousa in Mönchengladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Friseursalon Mousa | Premium Friseursalon Mönchengladbach" />
        <meta
        ...
        <meta name="twitter:title" content="Friseursalon Mousa | Premium Friseursalon Mönchengladbach" />
        <meta
